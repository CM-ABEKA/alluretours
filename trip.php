            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li>
                        ...
                        <a class="nav-link scrollto" href="#cta"> Gallery</a>
                    </li>
            ...
            <div class="">
                <form class="row g-3">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control" name="destination" id="inputAddress2"
                            placeholder="Eg. Bogoria">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="gridCheck">
                                I agree to have read and understood all terms and conditions.
                            </label>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0 mx-auto">
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                            ...
                            <div class="text-center">
                                <button class="btn btn-outline-success" type="submit"><i class="fa fa-envelope"></i>
                                    Send Message</button>
                            </div>
                        </form>
                    </div>
